...
function MyWork() {
    ...
    return (
        <section  ref={ref} id="work" className={classes.worksection}>
            ...
            <ProjectCard projectRoute="http://localhost:3000/windows-forms-app" link="https://github.com/IvanValdesF/SistemaVentasWinForms" image={require("../images/FormsAppImages/ventasImage.png")} title="Store Managment App" tools="Windows Forms" tools2="Send Emails" description="In this project my co-worker and me made a windows forms app 
            with the purpose of manage a clothing store inventory, sells, purchases, clients and employees."/>
            <ProjectCard projectRoute="http://localhost:3000/windows-forms-app-api" link="https://github.com/IvanValdesF/VentasAPIv2" image={require("../images/APIImages/apiImage.png")} title="Store Managment API" tools="ASP .NET Core" tools2="JSON Web Tokens" tools3="MySQL" description="I made an API 
            to abstract the logic of my Store Managment App in order to share it with an online store that is still in development."/>
            <ProjectCard projectRoute="http://localhost:3000/linear-regression-app" link="https://github.com/IvanValdesF/PythonRegresionLinealUsage" image={require("../images/regresionImage.png")} title="Linear Regression App" tools="Python" tools2="Tensorflow" tools3="Sqlite" tools4="Tkinter" tools5="Numpy | Matplotlib" 
